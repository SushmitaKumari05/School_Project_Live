...
import {Card,CssBaseline,Grid,TextField,Typography} from "@material-ui/core";
...
const UpdateList = () => {
  ...
  const onSubmit = async e => {
    e.preventDefault();
    await axios.put(`https://ak-sms-api.herokuapp.com/api/v1/student/${id}`,item);
    history.push("/ListView");
  };

  const loadUser = async () => {
    const result = await axios.get(`https://ak-sms-api.herokuapp.com/api/v1/student/${id}`);
  ...
  return (
   ...
   <Typography variant="h3" style={{ textAlign:"center"}} gutterBottom>Update User</Typography>
